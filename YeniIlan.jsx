...
import { Tag } from './Tag'
import { RENKLER, TIP_LABEL } from '../data/mock'
import { Users, Home, RefreshCw, Search, Dumbbell, BookOpen, Calendar, ChevronRight } from 'lucide-react'
...
export default function IlanCard({ ilan }) {
  ...
  const Icon = TIP_ICON[ilan.tip] || Users
    ...
    >
      ...
      <div className="flex items-start justify-between gap-3 mb-2">
        <div className="flex items-start gap-2.5 flex-1 min-w-0">
          ...
          >
            <Icon size={15} style={{ color: r.c }} strokeWidth={2} />
          </div>
          <h3 className="font-syne font-bold text-[15px] leading-snug">
            {ilan.baslik}
          </h3>
        </div>
      ...
      {/* Açıklama */}
      <p className="text-[#6b6b82] text-[13px] leading-relaxed mb-3 line-clamp-2 pl-[42px]">
        {ilan.aciklama}
      </p>
